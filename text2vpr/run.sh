...
python eval_vpr.py --vpr_dim=8448 --vpr_model_name=salad --is_dual_encoder=1 --dual_encoder_fusion=cat --fusion_type=none --is_pca=0 --text_model_name=lightonai/modernbert-embed-large --text_dim=4096
...
python eval_vpr.py --vpr_dim=10752 --vpr_model_name=cricavpr --is_dual_encoder=1 --dual_encoder_fusion=cat --fusion_type=none --is_pca=0 --text_model_name=lightonai/modernbert-embed-large --text_dim=4096
