...
def parse_arguments():
    ...
    #parser.add_argument("--model_name", type=str, default='LOGS/resnet50/lightning_logs/version_22_dynamic_pooling_no_norm/checkpoints/resnet50_epoch(09)_step(5210).ckpt')
