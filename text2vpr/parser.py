...
def parse_arguments():
    ...
    #parser.add_argument("--vpr_dim", type=int, default=5376, help="_")
    parser.add_argument("--text_dim", type=int, default=1024, help="_")
    #parser.add_argument("--text_dim", type=int, default=384, help="_")    
    ...
    #parser.add_argument("--queries_csv", type=str, default="/mnt/d/data/amstertime/test/amstertime_objects_cleaned_all.csv")        
    #parser.add_argument("--queries_csv", type=str, default="/mnt/d/data/amstertime/test/amstertime_objects_cleaned_part.csv")        
    ...
    #parser.add_argument("--model_name", type=str, default='LOGS/resnet50/lightning_logs/version_50_cricas-bges-dynamic/checkpoints/resnet50_epoch(02)_step(1563)_R1[0.4639]_R5[0.6791].ckpt')
    parser.add_argument("--model_name", type=str, default='')
    parser.add_argument("--vpr_model_name", type=str, default="mixvpr")
    #parser.add_argument("--vpr_model_name", type=str, default="cricavpr_small")
    ...
    #parser.add_argument("--text_model_name", type=str, default="BAAI/bge-small-en-v1.5")
    ...
    parser.add_argument("--dual_encoder_fusion", type=str, default="none", help="cat/each")    
