...
python train.py --cross_modal=2 --fusion_type=none --vpr_model_name=openai/clip-vit-base-patch32 --vpr_dim=512 --is_text_pooling=0 
--is_image_pooling=0 --image_size=224 --is_trainable_text_encoder=1 --loss_name=MultiSimilarityLoss --batch_size=20
