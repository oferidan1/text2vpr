...
class QueryTextDataset(data.Dataset):
    def __init__(self, csv_path, image_root, image_size=512, resize_test_imgs=False):
        self.csv_path = csv_path
        self.images_paths, self.descriptions = read_csv_file(csv_path, image_root)
    ...
    def __getitem__(self, index):
        ...
        return normalized_img, index, text
