...
val_ds = TestDataset(args.val_set_folder, positive_dist_threshold=args.positive_dist_threshold,
                     image_size=args.image_size, resize_test_imgs=args.resize_test_imgs, labels_csv=args.val_csv, image_root=args.image_root)
test_ds = TestDataset(args.test_set_folder, queries_folder="queries_v1",
                      positive_dist_threshold=args.positive_dist_threshold,
                      image_size=args.image_size, resize_test_imgs=args.resize_test_imgs, labels_csv=args.test_csv, image_root=args.image_root)
...
for epoch_num in range(start_epoch_num, args.epochs_num):
    ...
    for iteration in tqdm(range(args.iterations_per_epoch), ncols=100):
        images, targets, _, texts = next(dataloader_iterator)
