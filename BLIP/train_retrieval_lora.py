...
from data import create_dataset, create_sampler, create_loader, create_loader_1
...
def main(args, config):
    ...
    train_loader = create_loader_1(train_dataset, samplers[0], config['batch_size_train'], 4, True, None)   
...
if __name__ == '__main__':
    ...
    parser.add_argument('--is_adapter', default=1, type=int)    
