...
def main():
    # load images
    query_path = '/mnt/d/data/amstertime/test/queries/'         # path to query images folder path
    datasets_path = '/mnt/d/data/amstertime/test/database/'      # path to database images folder path
    ...
    # load model
    model = load_model('./checkpoints/resnet50_MixVPR_4096_channels(1024)_rows(4).ckpt')
