...
from utils.multi_similarity_loss_sij_ import MultiSimilarityLoss_Sij
...
#    if loss_name == 'MultiSimilarityLoss': return losses.MultiSimilarityLoss(alpha=1.0, beta=50, base=0.0, distance=DotProductSimilarity())
    if loss_name == 'MultiSimilarityLoss': return MultiSimilarityLoss_Sij(alpha=1.0, beta=50, base=0.0, distance=DotProductSimilarity())
